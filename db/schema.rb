...
ActiveRecord::Schema.define(version: 20160610004355) do

  create_table "event_attendance_records", force: :cascade do |t|
    t.integer  "event_id"
    t.boolean  "present"
    t.boolean  "fed"
    t.boolean  "milk_only"
  ...
  add_index "event_attendance_records", ["event_id", "created_at"], name: "index_event_attendance_records_on_event_id_and_created_at"
  add_index "event_attendance_records", ["event_id"], name: "index_event_attendance_records_on_event_id"
  add_index "event_attendance_records", ["student_id"], name: "index_event_attendance_records_on_student_id"
